...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    prefecture = models.CharField(default='', max_length=50, verbose_name='都道府県')
    city = models.CharField(default='', max_length=50, verbose_name='市町村')
    address1 = models.CharField(default='', max_length=50, verbose_name='住所1 丁目・番地・号')
    ...
    tel = models.CharField(default='', max_length=15, verbose_name='電話番号')
